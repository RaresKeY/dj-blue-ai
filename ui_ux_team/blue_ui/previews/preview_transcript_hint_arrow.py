...
class TranscriptHintArrowPreview(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("TranscriptHintArrowPreview")
        self.resize(560, 420)
        ...
        self._arrow = TranscriptHintArrow(self._stage)
        self._layout_arrow()
    ...
    def _layout_arrow(self):
        cx = self._stage.width() // 2
        cy = self._stage.height() // 2
...
if __name__ == "__main__":
    ...
    window = TranscriptHintArrowPreview()
    window.show()
