...
| [Operations: Build & Release](operations_build_release.md) | `.github/workflows/build.yml`, `build_binary.py`, `build_appimage.py`, `build_nuitka.py`, `architects/design_docs/TAGGING_GUIDE.md` | Build artifacts, CI release triggers, release tagging policy, and commit workflow policy. |
